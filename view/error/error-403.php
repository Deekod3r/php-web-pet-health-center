...
<head>
    <title>Không có quyền truy cập | CarePET</title>
...
<body>
    <div style="margin-top: 10%">
        ...
        <div class="forbiddenmessage" style="margin-top: 6%">
            <h1>403</h1>
            <h3>Bạn không có quyền truy cập vào trang này</h3>
            <a href="?controller=home&action=index" style="font-size:20px; color: white; font-weight: bold; text-decoration: none; margin-top:40px">CLICK: BACK TO HOME</a>
        </div>
    </div>
