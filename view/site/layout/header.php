        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-1 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-1" id="navbarCollapse">
                ...
                <?php if (isset($_SESSION['login']) && $_SESSION['login'] == true) { ?>
                    <a href="?controller=customer&action=customer_info" class="btn btn-primary px-3 d-none d-lg-block" style="margin-right: 5px">Thông tin tài khoản</a>
                    <a href="?controller=home&action=logout" class="btn btn-primary px-3 d-none d-lg-block">Đăng xuất</a>
                <?php } else { ?>
                    <a href="?controller=home&action=login_page" class="btn btn-primary px-3 d-none d-lg-block">Đăng nhập</a>
                <?php } ?>
            </div>
        </nav>
    </div>
