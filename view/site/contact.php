        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="index.html" class="nav-item nav-top nav-link">Home</a>
                    <a href="about.html" class="nav-item nav-top nav-link">About</a>
                    <a href="service.html" class="nav-item  nav-topnav-link">Service</a>
                    <a href="price.html" class="nav-item  nav-top nav-link">Price</a>
                    <a href="booking.html" class="nav-item nav-top nav-link">Booking</a>
                    <div class="nav-item nav-top dropdown">
                    ...
                    <a href="contact.html" class="nav-item nav-top nav-link active">Contact</a>
                </div>
