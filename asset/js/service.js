...
function loadDataService(data) {
    ...
    data.forEach((element) => {
        ...
        serviceData +=
            "<li class='list-group-item p-2' style='font-size: 18px; font-weight: bold; height: 65px'><i class='fa fa-solid fa-cat text-secondary mr-2'></i>" +
            element.sv_name +
            "</li>";
        serviceData +=
            "<li class='list-group-item p-2' style='font-size: 18px; font-weight: bold; height: 20px'><i class='fa fa-solid fa-dollar-sign text-secondary mr-2' aria-hidden='true'></i>Giá: " +
            sv_price +
            "</li>";
        serviceData += "</ul>";
        serviceData += "</div>";
